...
export function get_deployments(){
  var endpoint    = "deployments"
  var method      = "get"
  var parameters  = {take: 1000}
  return make_api_call(endpoint, method, parameters)
}

export function get_deployment(deployment_id){
  var endpoint    = "deployments/{0}".format(deployment_id)
  var method      = "get"
  var parameters  = {}
  return make_api_call(endpoint, method, parameters)
}

export function get_releases(){
  var endpoint    = "releases"
  var method      = "get"
  var parameters  = {}
  return make_api_call(endpoint, method, parameters)
}
export function get_release(release_id){
  var endpoint    = "releases/{0}".format(release_id)
  var method      = "get"
  var parameters  = {}
  return make_api_call(endpoint, method, parameters)
}

export function get_task(task_id){
  var endpoint    = "tasks/{0}".format(task_id)
  var method      = "get"
  var parameters  = {}
  return make_api_call(endpoint, method, parameters)
}
